...
Note: This data repository also includes metrics (In scripts as Trailing-Edge Slope, Riemann Sum Integral) and elevations at locations (in scripts as 50km-NEEM, Similar-NEEM) not included in the study.
